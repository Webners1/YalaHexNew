...
const Header = ({account,loadweb3,disconnect}) => {
            ...
            <nav className="classy-navbar justify-content-between" id="dreamNav">
              ...
              <div className="classy-menu">
                ...
                <div className="classynav">
                 ...
                 {!account? 
               (  <a className="btn login-btn ml-50" onClick={loadweb3}>Connect</a>)
                 :(<>
                 <a className="btn login-btn ml-50" style={{}}>{account}</a>
                    <a className="btn login-btn ml-50" onClick={disconnect}>Disconnect</a>
                 </>
